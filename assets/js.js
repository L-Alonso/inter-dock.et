...
//to determine past, current and future.
    $(".input").each(function () {
...
$(".saveBtn").click(function() {
    eventNarr = $(this).siblings(".input").val();
    console.log(eventNarr);
    eventTime = $(this).siblings(".hour").text();
    console.log(eventTime);
    localStorage.setItem(eventTime, JSON.stringify(eventNarr));
